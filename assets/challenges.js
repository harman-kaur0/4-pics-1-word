export const challenges = {
    1: {
        answer: "beginning",
        images: [
            require("../assets/challenges/beginning/1.png"),
            require("../assets/challenges/beginning/2.png"),
            require("../assets/challenges/beginning/3.png"),
    ...
    61: {
        answer: "women",
        images: [
            require("../assets/challenges/women/1.png"),
            require("../assets/challenges/activist/2.png"),     
            require("../assets/challenges/women/2.png"),
    ...
    214: {
        answer: "sandwich",
        images: [
            require("../assets/challenges/sandwich/1.png"),
            require("../assets/challenges/sandwich/2.png"),
            require("../assets/challenges/sandwich/3.png"),
            require("../assets/challenges/sandwich/4.png")
        ]
    },
    215: {
        answer: "melon",
    ...
    255: {
        answer: "camelot",
        images: [
            require("../assets/challenges/camelot/1.png"),
            require("../assets/challenges/camelot/2.png"),
            require("../assets/challenges/camelot/3.png"),
            require("../assets/challenges/camelot/4.png")
        ]
    },
    256: {
        answer: "aquatic",
    ...
    258: {
        answer: "button",
        images: [
            require("../assets/challenges/button/1.png"),
            require("../assets/challenges/button/2.png"),
            require("../assets/challenges/button/3.png"),
    ...
    273: {
        answer: "yodel",
        images: [
            require("../assets/challenges/yodel/1.png"),
            require("../assets/challenges/yodel/2.png"),
            require("../assets/challenges/yodel/3.png"),
            require("../assets/challenges/yodel/4.png")
        ]
    },
    274: {
        answer: "pumpkin",
    ...
    279: {
        ...
        images: [
            require("../assets/challenges/twilight/2.png"),
            require("../assets/challenges/haunted/1.png"),
    ...
    288: {
        answer: "jazz",
        images: [
            require("../assets/challenges/jazz/1.png"),
            require("../assets/challenges/jazz/2.png"),
            require("../assets/challenges/jazz/3.png"),
            require("../assets/challenges/jazz/4.png")
        ]
    },
    289: {
        answer: "unique",
    ...
    292: {
        ...
        images: [
            ...
            require("../assets/challenges/jogger/2.png"),
            require("../assets/images/5/shoes/2.png"),         
    ...
    305: {
        ...
        images: [
            require("../assets/challenges/wonder/1.png"),
            require("../assets/challenges/wonder/2.png"),
            require("../assets/challenges/wonder/3.png"),
            require("../assets/challenges/wonder/4.png")
        ]
    },
    306: {
        answer: "settlers",
        images: [
            require("../assets/challenges/settlers/1.png"),
            require("../assets/challenges/settlers/2.png"),
            require("../assets/challenges/settlers/3.png"),
            require("../assets/challenges/settlers/4.png")    
        ]
    },
    307: {
        answer: "recipe",
    ...
    308: {
        answer: "diwali",
        images: [
            require("../assets/challenges/diwali/1.png"),
            require("../assets/challenges/diwali/2.png"),
            require("../assets/challenges/diwali/3.png"),
            require("../assets/challenges/diwali/4.png")    
        ]
    },
    309: {
        answer: "bombard",
        images: [
            require("../assets/challenges/bombard/1.png"),
            require("../assets/images/17/cannons/2.png"),
            require("../assets/challenges/bombard/2.png"),
    ...
    310: {
        answer: "typhoon",
        images: [
            require("../assets/challenges/typhoon/1.png"),
            require("../assets/challenges/typhoon/2.png"),
            require("../assets/challenges/typhoon/3.png"),
            require("../assets/challenges/typhoon/4.png")    
        ]
    },
    311: {
        answer: "november",
    ...
    313: {
        answer: "tasty",
        images: [
            require("../assets/challenges/tasty/1.png"),
            require("../assets/challenges/parfait/3.png"),
            require("../assets/challenges/chestnut/3.png"),
    ...
    314: {
        answer: "beggar",
        images: [
            require("../assets/challenges/beggar/1.png"),
            require("../assets/challenges/beggar/2.png"),
            require("../assets/challenges/beggar/3.png"),
            require("../assets/challenges/beggar/4.png")    
        ]
    },
    315: {
        answer: "veterans",
        images: [
            require("../assets/challenges/veterans/1.png"),
            require("../assets/challenges/veterans/2.png"),
            require("../assets/challenges/veterans/3.png"),
            require("../assets/challenges/veterans/4.png")    
        ]
    },
    316: {
        answer: "armistice",
        images: [
            require("../assets/challenges/armistice/1.png"),
            require("../assets/challenges/armistice/2.png"),
            require("../assets/challenges/armistice/3.png"),
            require("../assets/challenges/armistice/4.png")    
        ]
    },
    317: {
        answer: "nacho",
    ...
    318: {
        answer: "native",
        images: [
            require("../assets/challenges/native/1.png"),
            require("../assets/challenges/native/2.png"),
            require("../assets/challenges/native/3.png"),
    ...
    323: {
        answer: "thankful",
        images: [
            require("../assets/challenges/thankful/1.png"),
            require("../assets/challenges/thankful/2.png"),
            require("../assets/challenges/thankful/3.png"),
            require("../assets/challenges/grateful/2.png")  
        ]
    },
    324: {
        answer: "gobble",
        images: [
            ...
            require("../assets/challenges/gobble/2.png"),
            require("../assets/challenges/gobble/3.png"),
            require("../assets/challenges/gobble/4.png")
        ]
    },
    325: {
        answer: "cornbread",
        images: [
            require("../assets/challenges/cornbread/1.png"),
            require("../assets/challenges/cornbread/2.png"),
            require("../assets/images/11/popcorn/3.png"),
            require("../assets/challenges/cornbread/4.png")    
        ]
    },
    326: {
        answer: "turkey",
    ...
    327: {
        answer: "cranberry",
        images: [
            require("../assets/challenges/cranberry/1.png"),
            require("../assets/challenges/cranberry/2.png"),
            require("../assets/challenges/cranberry/3.png"),
            require("../assets/challenges/cranberry/4.png")    
        ]
    },
    328: {
        answer: "friends",
        images: [
            require("../assets/challenges/friends/1.png"),
            require("../assets/challenges/friends/2.png"),
            require("../assets/challenges/friends/3.png"),
    ...
    329: {
        ...
        images: [
            require("../assets/challenges/parfait/1.png"),
            require("../assets/challenges/parfait/2.png"),
            require("../assets/challenges/parfait/3.png"),
            require("../assets/challenges/parfait/4.png")    
        ]
    },
    330: {
        answer: "family",
        images: [
            require("../assets/challenges/family/1.png"),
            require("../assets/challenges/family/2.png"),
            require("../assets/challenges/family/3.png"),
    ...
    331: {
        answer: "harvest",
        images: [
            require("../assets/challenges/harvest/1.png"),
            require("../assets/challenges/harvest/2.png"),
            require("../assets/challenges/harvest/3.png"),
            require("../assets/challenges/harvest/4.png")    
        ]
    },
    332: {
        answer: "hanukkah",
        images: [
            require("../assets/challenges/hanukkah/1.png"),
            require("../assets/challenges/hanukkah/2.png"),
            require("../assets/challenges/hanukkah/3.png"),
            require("../assets/challenges/hanukkah/4.png")    
        ]
    },
    333: {
        answer: "consumer",
        images: [
            require("../assets/challenges/consumer/1.png"),
            require("../assets/challenges/consumer/2.png"),
            require("../assets/challenges/consumer/3.png"),
            require("../assets/challenges/gobble/4.png")    
        ]
    },
    334: {
        answer: "banquet",
        images: [
            require("../assets/challenges/banquet/1.png"),
            require("../assets/challenges/banquet/2.png"),
            require("../assets/challenges/banquet/3.png"),
            require("../assets/challenges/banquet/4.png")    
        ]
    },
    335: {
        answer: "granny",
        images: [
            require("../assets/challenges/granny/1.png"),
            require("../assets/challenges/granny/2.png"),
            require("../assets/challenges/granny/3.png"),
            require("../assets/challenges/granny/4.png")    
        ]
    },
    336: {
        answer: "holiday",
    ...
    338: {
        answer: "freezing",
        images: [
            require("../assets/challenges/freezing/1.png"),  
            require("../assets/challenges/freezing/2.png"),
            require("../assets/challenges/freezing/3.png"),
    ...
    339: {
        answer: "traveler",
        images: [
            require("../assets/challenges/traveler/1.png"),
            require("../assets/challenges/traveler/2.png"),
            require("../assets/challenges/traveler/3.png"),
            require("../assets/images/6/flies/4.png")    
        ]
    },
    340: {
        answer: "decimal",
        images: [
            require("../assets/challenges/decimal/1.png"),
            require("../assets/challenges/decimal/2.png"),
            require("../assets/challenges/decimal/3.png"),
            require("../assets/challenges/decimal/4.png")    
        ]
    },
    341: {
        answer: "kwanzaa",
        images: [
            require("../assets/challenges/kwanzaa/1.png"),
            require("../assets/challenges/kwanzaa/2.png"),
            require("../assets/challenges/kwanzaa/3.png"),
            require("../assets/challenges/kwanzaa/4.png")    
        ]
    },
    342: {
        answer: "reindeer",
        images: [
            require("../assets/challenges/reindeer/1.png"),
            require("../assets/challenges/reindeer/2.png"),
            require("../assets/challenges/reindeer/3.png"),
            require("../assets/challenges/sleigh/1.png")    
        ]
    },
    343: {
        answer: "magic",
        images: [
            require("../assets/challenges/magic/1.png"),
            require("../assets/challenges/magic/2.png"),
            require("../assets/challenges/miracle/3.png"),
    ...
    344: {
        ...
        images: [
            require("../assets/challenges/sleigh/1.png"),
            require("../assets/challenges/sleigh/2.png"),
            require("../assets/challenges/sleigh/3.png"),
            require("../assets/challenges/reindeer/3.png")    
        ]
    },
    345: {
        answer: "electric",
        images: [
            require("../assets/challenges/electric/1.png"),
            require("../assets/challenges/electric/2.png"),
            require("../assets/challenges/electric/3.png"),
            require("../assets/challenges/electric/4.png")    
        ]
    },
    346: {
        answer: "prayer",
        images: [
            require("../assets/challenges/prayer/1.png"),
            require("../assets/challenges/prayer/2.png"),
            require("../assets/challenges/thankful/2.png"),
    ...
    347: {
        ...
        images: [
            require("../assets/challenges/reindeer/3.png"),   
            require("../assets/challenges/christmas/1.png"),
    ...
    348: {
        answer: "evergreen",
        images: [
            require("../assets/challenges/evergreen/1.png"),
            require("../assets/challenges/evergreen/2.png"),
            require("../assets/challenges/evergreen/3.png"),
            require("../assets/images/12/winter/2.png") 
        ]
    },
    349: {
        answer: "eggnog",
        images: [
            require("../assets/challenges/eggnog/1.png"),
            require("../assets/challenges/eggnog/2.png"),
            require("../assets/challenges/eggnog/3.png"),
            require("../assets/challenges/eggnog/4.png")    
        ]
    },
    350: {
        answer: "stocking",
        images: [
            require("../assets/challenges/stocking/1.png"),
            require("../assets/challenges/stocking/2.png"),
            require("../assets/challenges/stocking/3.png"),
            require("../assets/challenges/coal/4.png")    
        ]
    },
    351: {
        answer: "mistletoe",
        images: [
            require("../assets/challenges/mistletoe/1.png"),
            require("../assets/challenges/mistletoe/2.png"),
            require("../assets/challenges/mistletoe/3.png"),
            require("../assets/challenges/mistletoe/4.png")    
        ]
    },
    352: {
        answer: "underdog",
        images: [
            ...
            require("../assets/challenges/underdog/2.png"),
            require("../assets/challenges/underdog/1.png"),
            require("../assets/challenges/underdog/3.png"),
        ]
    },
    353: {
        answer: "sweater",
        images: [
            require("../assets/challenges/sweater/1.png"),
            require("../assets/challenges/sweater/2.png"),
            require("../assets/challenges/sweater/3.png"),
    ...
    354: {
        answer: "coal",
        images: [
            require("../assets/challenges/coal/1.png"),
            require("../assets/challenges/coal/2.png"),
            require("../assets/challenges/coal/3.png"),
            require("../assets/challenges/coal/4.png")    
        ]
    },
    355: {
        answer: "december",
        images: [
            require("../assets/challenges/december/1.png"),
            require("../assets/challenges/kwanzaa/4.png"),
            require("../assets/images/12/winter/2.png"),
            require("../assets/challenges/hanukkah/3.png")    
        ]
    ...
    356: {
        answer: "alphabet",
        images: [
            require("../assets/challenges/alphabet/1.png"),
            require("../assets/images/15/letter/1.png"),
            require("../assets/images/15/vowel/1.png"),
            require("../assets/challenges/alphabet/2.png")
        ]
    },
    357: {
        answer: "jolly",
        images: [
            require("../assets/challenges/jolly/1.png"),
            require("../assets/challenges/jolly/2.png"),
            require("../assets/challenges/jolly/3.png"),
            require("../assets/challenges/christmas/1.png")
        ]
    },
    358: {
        answer: "ginger",
        images: [
            require("../assets/challenges/ginger/1.png"),
            require("../assets/challenges/ginger/2.png"),
            require("../assets/challenges/ginger/3.png"),
            require("../assets/challenges/ginger/4.png")    
        ]
    },
    359: {
        answer: "christmas",
    ...
    360: {
        answer: "grateful",
        images: [
            require("../assets/challenges/grateful/1.png"),
            require("../assets/challenges/grateful/2.png"),
            require("../assets/challenges/grateful/3.png"),
            require("../assets/challenges/miracle/2.png")    
        ]
    },
    361: {
        ...
        images: [
            require("../assets/challenges/gifts/1.png"),
            require("../assets/challenges/gifts/2.png"),
    ...
    362: {
        answer: "chestnut",
        images: [
            require("../assets/challenges/chestnut/1.png"),
            require("../assets/challenges/chestnut/2.png"),
            require("../assets/challenges/chestnut/3.png"),
            require("../assets/challenges/chestnut/4.png")    
        ]
    },
    363: {
        answer: "pepper",
        images: [
            require("../assets/challenges/pepper/1.png"),
            require("../assets/challenges/pepper/2.png"),
            require("../assets/challenges/pepper/3.png"),
            require("../assets/challenges/pepper/4.png")    
        ]
    },
    364: {
        answer: "fountain",
        images: [
            require("../assets/challenges/fountain/1.png"),
            require("../assets/challenges/fountain/2.png"),
            require("../assets/challenges/fountain/3.png"),
            require("../assets/challenges/fountain/4.png")    
        ]
    },
    365: {
        answer: "miracle",
