export const charData = {
    ...
    alex: {
        cost: 500,
        perk: "Receive 10 trash hints and 10 letter hints.",
    ...
    leyla: {
        cost: 750,
        perk: "Receive 5 of each hint (wand, trash, letter).",
    ...
    steve: {
        cost: 1500,
        perk: "Max hearts increased by 2.",
    ...
    evelyn: {
        cost: 3000,
        perk: "Use 1 wand per day at no cost.",
    ...
    scarlett: {
        cost: 6000,
        perk: "Heart refresh time is halved.",
    ...
    michael: {
        cost: 7000,
        perk: "Heart refreshes every 10 minutes.",
    ...
    emma: {
        cost: 8000,
        perk: "Max hearts increased by 5.",
    ...
    matthew: {
        cost: 9000,
        perk: "30 seconds added to each level.",
    ...
    chunli: {
        cost: 10000,
        perk: "First letter revealed for each word.",
